      ...
      <section id="hero" className="min-h-screen flex flex-col items-center justify-center text-center gap-5 px-10">
          ...
          <div className={`absolute bottom-4 left-0 right-0 flex items-center justify-center gap-2 transition-opacity duration-400 ${scrolled ? "opacity-0 pointer-events-none" : "opacity-100"}`}>
            <div className="absolute bottom-12 left-0 right-0 flex items-center justify-center gap-8">
              <a href="https://github.com/Noah-Rothschild" target="_blank" rel="noopener noreferrer" className="font-comfortaa text-xs uppercase tracking-wider text-gray-500 inline-flex hover:text-gray-900 transition-colors duration-200">
              ...
              <a href="https://www.linkedin.com/in/noah-rothschild-095270202/" target="_blank" rel="noopener noreferrer" className="font-comfortaa text-xs uppercase tracking-wider text-gray-500 hover:text-gray-900 transition-colors duration-200"> <img src="/images/linkedin.png" alt="LinkedIn Icon" className="inline-block w-4 h-4 mr-1" />
                LinkedIn
              </a>
              <a href="mailto:nprothschild@gmail.com" className="font-comfortaa text-xs uppercase tracking-wider text-gray-500 hover:text-gray-900 transition-colors duration-200"> <img src="/images/email.png" alt="Email Icon" className="inline-block w-4 h-4 mr-1" />
                Email
              </a>
            </div>
